...
```python
# A5/frontend/mock_data/mock_cv.py
...
```python
# A5/frontend/mock_data/mock_sensors.py
...
```python
# A5/frontend/mock_data/mock_positioning.py
...
```python
# A5/frontend/mock_data/mock_vl.py
...
```python
# A5/frontend/mock_data/mock_work_permit.py
...
| 8 | `frontend/` FastAPI + WebSocket 前端 | ✅ |
...
├── frontend/                   Web 前端(FastAPI+WebSocket)
│   ├── app.py, README.md
